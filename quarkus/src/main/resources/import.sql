-- Inserting authors
INSERT INTO authors (id, name, surname, dateofbirth)
VALUES (1, 'Jane', 'Austen', '1775-12-16'),
...
INSERT INTO books (id, title, isbn, price, yearofrelease, author_id)
VALUES (1, 'Pride and Prejudice', '978-3-16-148410-0', 9.99, 1813, 1),
       (2, 'Sense and Sensibility', '978-3-16-148411-7', 8.99, 1811, 1),
       (3, 'Emma', '978-3-16-148412-4', 10.99, 1815, 1);

-- Author 2: Mark Twain
INSERT INTO books (id, title, isbn, price, yearofrelease, author_id)
VALUES (4, 'Adventures of Huckleberry Finn', '978-1-40-283204-0', 12.99, 1884, 2),
